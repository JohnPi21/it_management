...
class Validation
{
    ...
    public $patterns = array(
        ...
        'email'         => '[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,15})'
    );
    ...
    public function boolPattern($name, $default = null)
    {
     ...
     * @return this
     */
    public function boolCustomPattern($pattern)
    {
